...
type UserEdges struct {
	// Mystore holds the value of the mystore edge.
	Mystore []*Store `json:"mystore,omitempty"`
	// loadedTypes holds the information for reporting if a
	// type was loaded (or requested) in eager-loading or not.
	loadedTypes [1]bool
}

// MystoreOrErr returns the Mystore value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) MystoreOrErr() ([]*Store, error) {
	if e.loadedTypes[0] {
		return e.Mystore, nil
	}
	return nil, &NotLoadedError{edge: "mystore"}
}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldUserID, user.FieldUserName, user.FieldBirthday, user.FieldType, user.FieldStoreID:
...
// QueryMystore queries the "mystore" edge of the User entity.
func (u *User) QueryMystore() *StoreQuery {
	return NewUserClient(u.config).QueryMystore(u)
}
