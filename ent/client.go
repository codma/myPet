...
// QueryUsers queries the users edge of a Store.
func (c *StoreClient) QueryUsers(s *Store) *UserQuery {
...
// QueryMystore queries the mystore edge of a User.
func (c *UserClient) QueryMystore(u *User) *StoreQuery {
